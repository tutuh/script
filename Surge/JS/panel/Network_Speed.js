...
[Script]
# Panel
network-speed-panel = type=generic,timeout=60,script-path=https://raw.githubusercontent.com/tutuh/script/master/Surge/JS/panel/Network_Speed.js,argument=icon=arrow.down.circle&icon-color=#5d84f8&mb=1
